...
Una.prototype.enableScreenless = function() {
    ...
    this.onScreenInput = function() {};
    this.onControllerInput = function() {};

    var registerInitState = function(fn) {
        this.initState = fn;
    }
    var registerOnScreenInput = function(fn) {
        this.onScreenInput = fn;
    }
    var registerOnControllerInput = function(fn) {
        this.onControllerInput = fn;
    }
