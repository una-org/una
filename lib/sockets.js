...
Sockets.prototype.register = function() {
    ...
    var registerClient = function(socket, type, data) {
        ...
        // We only acknowledge the screen at this point. Controllers
        // need to be acknowledged by the screen, so we wait till 
        // the screen sends acknowledge before we send ready to controller
        if (type == 'screen') {
